...
import { FcSearch, FcSettings, FcEngineering, FcShipped, FcAutomotive } from "react-icons/fc";
import { AiOutlineShoppingCart, AiOutlineAppstore, AiOutlineShopping } from "react-icons/ai";
import "./style.css";
    ...
    <>
      <form onSubmit={handleSubmit}>
        <div className="header">
          ...
          {loginCompContext.adminRole === "633790d637b11ff4da1d53fe" ? (<div></div>) : (<div className="search">
            <input
          ...
          {loginCompContext.token ? (
            <>
              ...
              {loginCompContext.adminRole === "633790d637b11ff4da1d53fe" ? (<div></div>) : (<div>
      ...
      <div className="categories-div-link">
        ...
        >
        <CgSmartHomeWashMachine size={20} className="icons-react"/> Appliances
        </Link>
        <Link
        ...
        ><IoManOutline size={20} className="icons-react"/> Beauty & Personal Care
        </Link>
        <Link
        ...
        >
        <AiOutlineShopping size={20} className="icons-react"/> Clothing, Shoes and Jewelry
        </Link>
        <Link 
        ...
        <Link
          ...
          className="categories-links"
          onClick={() => {productCompContext.filterByCategories("Electronics"); history("/products/categories/electronics")}}
        >
        <GiElectricalResistance size={20} className="icons-react"/> Electronics
        </Link>
      </div>
    </>
  );
